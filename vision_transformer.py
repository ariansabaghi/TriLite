...
if __name__ == '__main__':
    ...
    from vit_utils import neighbor_indices

    index_mask, divide_num = neighbor_indices(sz=14)
    divide_num = divide_num.unsqueeze(1).to(device)
    ...
    image_path = "ILSVRC2012_val_00000013_prediction_overlayed_heatmap.png"  # Replace with your image path
    ...
    feat, attn, qkv = model.get_intermediate_feat(image_tensor, n=1)
    ...
    attn = attn * index_mask.unsqueeze(0).repeat(1, 1, 1)
    print(attn)
